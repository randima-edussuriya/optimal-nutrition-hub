        ...
        if ($password == $row_data['staff_pwd']) {
            if ($row_data['staff_is_active'] == 1) { //check if user is active
                ...
                if ($_SESSION['staffTypeId'] == 1000) {
                    header("location:../home-pages/admin-home.php");
                    exit();
                } elseif ($_SESSION['staffTypeId'] == 1001) {
                    header("location:../home-pages/cashier-home.php");
                    exit();
                } elseif ($_SESSION['staffTypeId'] == 1002) {
                    header("location:../home-pages/inventory-manager-home.php");
                    exit();
                } elseif ($_SESSION['staffTypeId'] == 1003) {
                    header("location:../home-pages/deliver-home.php");
                    exit();
                }
            } else {
